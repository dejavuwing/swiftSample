...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, openURL url: NSURL, sourceApplication: String?, annotation: AnyObject) -> Bool {
        ...
        if let authResult = DropboxAuthManager.sharedAuthManager.handleRedirectURL(url) {
            ...
            case .Error(let error, let description):
                print("Dropbox authrazation Error \(error): \(description)")
            }
        }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ngle.swiftSample" in the application's documents Application Support directory.
